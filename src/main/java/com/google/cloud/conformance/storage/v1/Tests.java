...
public final class Tests {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "/google/cloud/conformance/storage/v1/tests.proto\022#google.cloud.conformance.stor"
          + "age.v1\032\037google/protobuf/timestamp.proto\"\255\001\n"
          + "\010TestFile\022L\n"
          + "\020signing_v4_tests\030\001 \003(\01322"
          + ".google.cloud.conformance.storage.v1.SigningV4Test\022S\n"
          + "\024post_policy_v4_tests\030\002 \003(\013"
          + "25.google.cloud.conformance.storage.v1.PostPolicyV4Test\"\211\005\n\r"
          + "SigningV4Test\022\020\n"
          ...
          + "\ttimestamp\030\007 \001(\0132\032.google.protobuf.Timestamp\022\023\n"
          + "\013expectedUrl\030\010 \001(\t\022P\n"
          + "\007headers\030\t \003(\0132?.google.cloud"
          + ".conformance.storage.v1.SigningV4Test.HeadersEntry\022a\n"
          + "\020query_parameters\030\n"
          + " \003(\0132G.g"
          + "oogle.cloud.conformance.storage.v1.SigningV4Test.QueryParametersEntry\022\016\n"
          + "\006scheme\030\013 \001(\t\022?\n"
          + "\010urlStyle\030\014"
          + " \001(\0162-.google.cloud.conformance.storage.v1.UrlStyle\022\033\n"
          + "\023bucketBoundHostname\030\r"
          + " \001(\t\022 \n"
          + "\030expectedCanonicalRequest\030\016 \001(\t\022\034\n"
          + "\024expectedStringToSign\030\017 \001(\t\032.\n"
          ...
          + "\010urlStyle\030\002"
          + " \001(\0162-.google.cloud.conformance.storage.v1.UrlStyle\022\033\n"
          + "\023bucketBoundHostname\030\003 \001(\t\022\016\n"
          + "\006bucket\030\004 \001(\t\022\016\n"
          + "\006object\030\005 \001(\t\022\022\n\n"
          + "expiration\030\006 \001(\005\022-\n"
          + "\ttimestamp\030\007 \001(\0132\032.google.protobuf.Timestamp\022L\n"
          + "\006fields\030\010 \003(\0132<.google.cloud.confor"
          + "mance.storage.v1.PolicyInput.FieldsEntry\022I\n\n"
          + "conditions\030\t"
          + " \001(\01325.google.cloud.conformance.storage.v1.PolicyConditions\032-\n"
          ...
          + "\006fields\030\002"
          + " \003(\0132=.google.cloud.conformance.storage.v1.PolicyOutput.FieldsEntry\022\035\n"
          + "\025expectedDecodedPolicy\030\003 \001(\t\032-\n"
          + "\013FieldsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\t:\0028\001\"\267\001\n"
          + "\020PostPolicyV4Test\022\023\n"
          + "\013description\030\001 \001(\t\022E\n"
          + "\013policyInput\030\002"
          + " \001(\01320.google.cloud.conformance.storage.v1.PolicyInput\022G\n"
          + "\014policyOutput\030\003"
          + " \001(\01321.google.cloud.conformance.storage.v1.PolicyOutput\"P\n\n"
          + "RetryTests\022B\n\n"
          + "retryTests\030\001 \003(\0132..google.cloud.conformance.storage.v1.RetryTest\"\'\n"
          + "\017InstructionList\022\024\n"
          + "\014instructions\030\001 \003(\t\"X\n"
          + "\006Method\022\014\n"
          + "\004name\030\001 \001(\t\022@\n"
          + "\tresources\030\002"
          + " \003(\0162-.google.cloud.conformance.storage.v1.Resource\"\344\001\n"
          + "\tRetryTest\022\n\n"
          + "\002id\030\001 \001(\005\022\023\n"
          + "\013description\030\002 \001(\t\022C\n"
          + "\005cases\030\003"
          + " \003(\01324.google.cloud.conformance.storage.v1.InstructionList\022<\n"
          + "\007methods\030\004 \003(\0132+.google.cloud.conformance.storage.v1.Method\022\034\n"
          ...
          + "\'com.google.cloud.conformance.storage.v1P\001Z#google/cloud/conformance/"
          + "storage/v1\252\002)Google.Cloud.Storage.V1.Tests.Conformanceb\006proto3"
    };
    descriptor =
