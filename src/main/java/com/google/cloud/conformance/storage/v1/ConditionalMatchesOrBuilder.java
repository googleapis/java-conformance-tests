...
public interface ConditionalMatchesOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.conformance.storage.v1.ConditionalMatches)
   ...
   */
  com.google.protobuf.ByteString getExpressionBytes(int index);
}
