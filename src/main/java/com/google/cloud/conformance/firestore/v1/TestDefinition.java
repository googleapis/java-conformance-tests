...
public final class TestDefinition {
  ...
  public static final class QueryTest extends com.google.protobuf.GeneratedMessageV3
    ...
    @java.lang.Override
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(collPath_)) {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "tests.proto\022%google.cloud.conformance.firestore.v1\032 google/firestore/v1/common.p"
          + "roto\032\"google/firestore/v1/document.proto"
          + "\032#google/firestore/v1/firestore.proto\032\037g"
          + "oogle/firestore/v1/query.proto\032\037google/protobuf/timestamp.proto\"F\n"
          + "\010TestFile\022:\n"
          + "\005tests\030\001 \003(\0132+.google.cloud.conformance.firestore.v1.Test\"\331\004\n"
          + "\004Test\022\023\n"
          + "\013description\030\001 \001(\t\022\017\n"
          + "\007comment\030\n"
          + " \001(\t\022=\n"
          + "\003get\030\002 \001(\0132..google.cloud.conformance.firestore.v1.GetTestH\000\022C\n"
          + "\006create\030\003"
          + " \001(\01321.google.cloud.conformance.firestore.v1.CreateTestH\000\022=\n"
          + "\003set\030\004 \001(\0132..google.cloud.conformance.firestore.v1.SetTestH\000\022C\n"
          + "\006update\030\005 \001(\01321.goog"
          + "le.cloud.conformance.firestore.v1.UpdateTestH\000\022N\n"
          + "\014update_paths\030\006 \001(\01326.google.cl"
          + "oud.conformance.firestore.v1.UpdatePathsTestH\000\022C\n"
          + "\006delete\030\007"
          + " \001(\01321.google.cloud.conformance.firestore.v1.DeleteTestH\000\022A\n"
          + "\005query\030\010"
          + " \001(\01320.google.cloud.conformance.firestore.v1.QueryTestH\000\022C\n"
          + "\006listen\030\t \001(\01321"
          + ".google.cloud.conformance.firestore.v1.ListenTestH\000B\006\n"
          + "\004test\"Y\n"
          + "\007GetTest\022\024\n"
          + "\014doc_ref_path\030\001 \001(\t\0228\n"
          ...
          + "\007request\030\003 \001(\0132\".google.firestore.v1.CommitRequest\022\020\n"
          + "\010is_error\030\004 \001(\010\"\273\001\n"
          + "\007SetTest\022\024\n"
          + "\014doc_ref_path\030\001 \001(\t\022@\n"
          + "\006option\030\002"
          + " \001(\01320.google.cloud.conformance.firestore.v1.SetOption\022\021\n"
          ...
          + "\tjson_data\030\003 \001(\t\0223\n"
          + "\007request\030\004 \001(\0132\".google.firestore.v1.CommitRequest\022\020\n"
          + "\010is_error\030\005 \001(\010\"\203\002\n"
          + "\017UpdatePathsTest\022\024\n"
          + "\014doc_ref_path\030\001 \001(\t\0227\n"
          + "\014precondition\030\002 \001(\0132!.google.firestore.v1.Precondition\022E\n"
          + "\013field_paths\030\003"
          + " \003(\01320.google.cloud.conformance.firestore.v1.FieldPath\022\023\n"
          ...
          + "DeleteTest\022\024\n"
          + "\014doc_ref_path\030\001 \001(\t\0227\n"
          + "\014precondition\030\002 \001(\0132!.google.firestore.v1.Precondition\0223\n"
          + "\007request\030\003 \001(\0132\".google.firestore.v1.CommitRequest\022\020\n"
          + "\010is_error\030\004 \001(\010\"Z\n"
          + "\tSetOption\022\013\n"
          + "\003all\030\001 \001(\010\022@\n"
          + "\006fields\030\002 \003(\0132"
          + "0.google.cloud.conformance.firestore.v1.FieldPath\"\245\001\n"
          + "\tQueryTest\022\021\n"
          + "\tcoll_path\030\001 \001(\t\022>\n"
          + "\007clauses\030\002 \003(\0132-.google.cloud.conformance.firestore.v1.Clause\0223\n"
          + "\005query\030\003 \001(\0132$.google.firestore.v1.StructuredQuery\022\020\n"
          + "\010is_error\030\004 \001(\010\"\210\004\n"
          + "\006Clause\022?\n"
          + "\006select\030\001"
          + " \001(\0132-.google.cloud.conformance.firestore.v1.SelectH\000\022=\n"
          + "\005where\030\002 \001(\0132,.google.cloud.conformance.firestore.v1.WhereH\000\022B\n"
          + "\010order_by\030\003"
          + " \001(\0132..google.cloud.conformance.firestore.v1.OrderByH\000\022\020\n"
          + "\006offset\030\004 \001(\005H\000\022\017\n"
          + "\005limit\030\005 \001(\005H\000\022A\n"
          + "\010start_at\030\006 \001(\0132-."
          + "google.cloud.conformance.firestore.v1.CursorH\000\022D\n"
          + "\013start_after\030\007"
          + " \001(\0132-.google.cloud.conformance.firestore.v1.CursorH\000\022?\n"
          + "\006end_at\030\010"
          + " \001(\0132-.google.cloud.conformance.firestore.v1.CursorH\000\022C\n\n"
          + "end_before\030\t \001(\0132-.google.cloud.conformance.firestore.v1.CursorH\000B\010\n"
          + "\006clause\"J\n"
          + "\006Select\022@\n"
          + "\006fields\030\001 \003(\01320.google.cloud.conformance.firestore.v1.FieldPath\"g\n"
          + "\005Where\022>\n"
          + "\004path\030\001 \001(\01320.google.cloud.conformance.firestore.v1.FieldPath\022\n\n"
          + "\002op\030\002 \001(\t\022\022\n\n"
          + "json_value\030\003 \001(\t\"\\\n"
          + "\007OrderBy\022>\n"
          + "\004path\030\001 \001(\01320.google.cloud.conformance.firestore.v1.FieldPath\022\021\n"
          + "\tdirection\030\002 \001(\t\"g\n"
          + "\006Cursor\022H\n"
          + "\014doc_snapshot\030\001"
          + " \001(\01322.google.cloud.conformance.firestore.v1.DocSnapshot\022\023\n"
          ...
          + "\tsnapshots\030\002"
          + " \003(\0132/.google.cloud.conformance.firestore.v1.Snapshot\022\020\n"
          + "\010is_error\030\003 \001(\010\"\251\001\n"
          + "\010Snapshot\022+\n"
          + "\004docs\030\001 \003(\0132\035.google.firestore.v1.Document\022A\n"
          + "\007changes\030\002 \003(\01320.google.cloud.conformance.firestore.v1.DocChange\022-\n"
          + "\tread_time\030\003 \001(\0132\032.google.protobuf.Timestamp\"\346\001\n"
          + "\tDocChange\022C\n"
          + "\004kind\030\001 \001(\01625.goog"
          + "le.cloud.conformance.firestore.v1.DocChange.Kind\022*\n"
          ...
          + "\010MODIFIED\020\003B\262\001\n"
          + ")com.google.cloud.conformance.firestore.v1B\016TestDefinitionZ%google/cloud/confo"
          + "rmance/firestore/v1\252\002\"Google.Cloud.Fires"
          + "tore.Tests.Proto\312\002(Google\\Cloud\\Firestore\\Tests\\Conformanceb\006proto3"
    };
    descriptor =
